...
export const sectionTitleClass =
  "text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-gray-800 via-gray-600 to-gray-700 bg-clip-text text-transparent w-auto justify-self-center";
export const sectionDescriptionClass =
  "md:text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed";
export const sectionDividerClass =
  "mt-6 md:mt-8 border-none h-1 bg-[var(--color-start-blue)] max-w-24 mx-auto rounded-full";
export const sectionContentClass = "mt-6 md:mt-8";
